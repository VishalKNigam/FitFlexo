          ...
          <div className="col-md-11 themeBg d-flex mt-4 rounded">
            <div className="row themeBg rounded">
              ...
              >
                ...
                <div className="themeBg">
                  <h4 className="themeBg text-white my-2"> Take Diet Check-list</h4>
                  <p className="themeBg text-white">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Ipsum, totam?
                  </p>
              ...
              >
                ...
                <div className="themeBg">
                  <h4 className="themeBg text-white my-2">Take Online Guidence</h4>
                  <p className="themeBg text-white">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Ipsum, totam?
                  </p>
        ...
        <div className="row ">
          ...
          >
            <h2 className="mt-md-3">
              Ready to be <span className="themeColor">Fit & Fine</span>
            </h2>
